...
if(isset($_POST['btn_submit']))
{
	...
	move_uploaded_file($path,"../Assets/user/photos/".$image);
	
	$proof=$_FILES['fileproof']['name'];
	$pathproof=$_FILES['fileproof']['tmp_name'];
	move_uploaded_file($pathproof,"../Assets/user/proofs/".$proof);	
	
	$ins="insert into tbl_user(user_name,user_email,user_contact,user_address,user_image,place_id,user_password,user_proof,user_age)
	values('$name','$email','$contact','$address','$image','$place','$password','$proof','$age')";
  ...
  <tr>
    ...
    <tr>
     ...
     <th><div align="left">Age</div></th>
      ...
      <input type="text" name="txt_age" id="txt_age"required="required"  /></td>
    </tr>
    <tr>
